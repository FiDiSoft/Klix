  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<CheckedProvider>(
            create: (context) => CheckedProvider()),
      ],
      child: Consumer<FormProvider>(builder: (_, formProvider, __) {
        return Consumer<CheckedProvider>(
            builder: (context, _checkProvider, __) {
          return Scaffold(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: BuildButton(
                        ...
                        btnText:
                            (formProvider.isEdit == false) ? 'Save' : 'Edit',
